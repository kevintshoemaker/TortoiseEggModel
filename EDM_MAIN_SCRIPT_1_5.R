...
# KTS: Divided code into a script and functions file

# KTS: Added a check to see how influential the climate variables were!

# KTS: Changed the egg production model- I realized it wasn't appropriate to include the PR process
   # in the egg production model, given the log transformation.

############
### TODO

# KTS: cross validation with site-level means
# KTS: C-V assumes knowledge of carapace length (should it?)
